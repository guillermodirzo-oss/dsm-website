...
export default function CityDeepCleanForm() {
      ...
      {step === 1 ? (
        <form onSubmit={handleNext} noValidate>
          <div className="space-y-4">
            <div>
              <label htmlFor="dc-firstname" className={labelClass}>First Name</label>
              <input
                id="dc-firstname"
                type="text"
                required
            ...
            <div>
              <label htmlFor="dc-phone" className={labelClass}>Phone Number</label>
              <input
                id="dc-phone"
                type="tel"
                required
            ...
            <div>
              <label htmlFor="dc-email" className={labelClass}>Email Address</label>
              <input
                id="dc-email"
                type="email"
                required
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="space-y-4">
            <div>
              <label htmlFor="dc-bedrooms" className={labelClass}>Bedrooms</label>
              <select
                id="dc-bedrooms"
                required
                value={bedrooms}
            ...
            <div>
              <label htmlFor="dc-bathrooms" className={labelClass}>Bathrooms</label>
              <select
                id="dc-bathrooms"
                required
                value={bathrooms}
            ...
            <div>
              <label htmlFor="dc-sqft" className={labelClass}>Square Footage</label>
              <select
                id="dc-sqft"
                required
                value={sqft}
