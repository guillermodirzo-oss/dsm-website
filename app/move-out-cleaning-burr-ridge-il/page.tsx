...
export const metadata: Metadata = {
  title: "Move-Out Cleaning Burr Ridge IL",
  description:
    ...
    <>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">How Much Does Move-Out Cleaning Cost in Burr Ridge, IL?</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="text-white">
              ...
              <p className="text-white/90 text-lg mb-6 leading-relaxed">
                Get your free move-out cleaning quote for Burr Ridge, IL. We&rsquo;ll get back to you fast.
