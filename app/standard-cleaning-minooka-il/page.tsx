...
const faqs = [
  {
    question: "How often should I schedule house cleaning in Minooka, IL?",
    answer:
      "Most Minooka families choose biweekly service, which keeps the home consistently clean without a large budget commitment. Households with young children, pets, or active lifestyles often prefer weekly cleaning. Monthly service works well for clients who do light maintenance between professional visits.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "We serve all of Minooka, including zip code 60447. This covers Minooka Acres, Heritage Fields, Fox Run, Aux Sable Creek Estates, and Old Town Minooka, as well as all neighborhoods along the Route 6 Corridor and throughout the surrounding Grundy and Will County area.",
  },
];
...
const serviceSchema = {
  ...
  name: "Standard Cleaning in Minooka, IL",
  provider: {
    "@type": "LocalBusiness",
  ...
  return (
    <>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="section-heading">Why Minooka Homeowners Choose DSM Cleaning Solutions</h2>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 mb-4 leading-relaxed">
            Standard cleaning in Minooka starts at {formatPrice(STANDARD_CLEANING_TIERS[0].price)} for a 2-bedroom home and scales with the
