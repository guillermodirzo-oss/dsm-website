      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            Pricing for deep cleaning in New Lenox starts around $200 for smaller homes. A 3 to 4 bedroom home typically runs $250 to $350 depending on your home&rsquo;s exact size, bedroom count, and bathroom count. Every quote is free and there are no hidden fees.
          </p>
