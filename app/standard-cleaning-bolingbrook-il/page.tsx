...
const faqs = [
  {
    question: "How often should I schedule recurring cleaning in Bolingbrook?",
    answer:
      "Most Bolingbrook families choose biweekly service, which keeps the home consistently clean without a large time or budget commitment. Households with kids, pets, or heavier foot traffic often prefer weekly. Monthly service is a great fit if you maintain light cleaning between visits.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Life happens. We ask for at least 24 hours' notice to reschedule your Bolingbrook appointment. Just give us a call at (815) 246-2113 or send us a message and we'll get you rebooked at a time that works for you.",
  },
];
...
const serviceSchema = {
  ...
  name: "Standard Cleaning in Bolingbrook, IL",
  provider: {
    "@type": "LocalBusiness",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Standard Cleaning", item: "https://www.dsmcleaningsolutions.com/standard-cleaning" },
    { "@type": "ListItem", position: 3, name: "Bolingbrook, IL", item: "https://www.dsmcleaningsolutions.com/standard-cleaning-bolingbrook-il" },
  ],
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold leading-tight mb-6">
              Standard Cleaning in Bolingbrook, IL
            </h1>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 mb-8 leading-relaxed">
            We&apos;ll provide a free, no-obligation estimate customized to your Bolingbrook home. Whether
