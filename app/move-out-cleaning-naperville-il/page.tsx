...
export const metadata: Metadata = {
  ...
  description:
    "Professional move-out cleaning in Naperville, IL. Spotless results backed by our 48-hr guarantee. 5-star rated, fully insured. Free estimate.",
...
const serviceSchema = {
  ...
  description:
    "Professional move-out cleaning in Naperville, IL. DSM Cleaning Solutions helps renters, landlords & home sellers. Eco-friendly, fully insured. Free estimate.",
};
