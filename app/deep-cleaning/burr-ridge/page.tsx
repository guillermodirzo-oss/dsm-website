...
const serviceSchema = {
  ...
  description:
    "Professional deep cleaning in Burr Ridge, IL. DSM Cleaning Solutions delivers thorough, white-glove deep cleans for Burr Ridge executive homes. Eco-friendly, fully insured, 48-hour satisfaction guarantee.",
};
