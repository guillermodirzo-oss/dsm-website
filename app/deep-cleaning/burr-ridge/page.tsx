      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            Pricing for deep cleaning in Burr Ridge typically starts around $250. A 3 to 4 bedroom home generally runs $350 to $500 depending on your home&rsquo;s exact size, bedroom count, and bathroom count. Every quote is free with no obligation.
          </p>
