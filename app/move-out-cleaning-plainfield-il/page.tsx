...
export const metadata: Metadata = {
  ...
  description: `Move-out cleaning in Plainfield IL built to get your deposit back. DSM Cleaning: 5-star rated, ${REVIEW_COUNT} Google reviews, 48-hr guarantee. Free quote.`,
...
const reviews3 = pickReviews(3, 3);
    ...
    <>
      ...
      <section className="py-14 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            We also serve landlords and property managers in Plainfield who need reliable turnover
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="section-heading">What&rsquo;s Included in Our Move-Out Cleaning in Plainfield, IL</h2>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">How Much Does Move-Out Cleaning Cost in Plainfield, IL?</h2>
