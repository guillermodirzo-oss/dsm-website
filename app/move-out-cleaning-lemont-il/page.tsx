...
export const metadata: Metadata = {
  title: "Move Out Cleaning Services Lemont IL",
  description:
    "Move-out cleaning in Lemont, IL. DSM Cleaning Solutions helps you get your deposit back. Fully insured. Free estimate.",
...
const trustCards = [
  ...
  { icon: "", title: "Fully Insured & Bonded", desc: "Background-checked team. Every Lemont job fully covered." },
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold leading-tight mb-6">
              Move-Out Cleaning Services in Lemont, IL
            </h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 mb-4 leading-relaxed">
            We&apos;re a family-owned cleaning company based in Romeoville, just minutes from Lemont.
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="section-heading">What&apos;s Included in Our Move-Out Cleaning in Lemont, IL</h2>
            <p className="section-subheading mx-auto">
              A complete, landlord-ready clean for your Lemont property.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="section-heading">Why Lemont Renters Choose DSM Cleaning Solutions</h2>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="section-heading mb-6">How Much Does Move-Out Cleaning Cost in Lemont, IL?</h2>
          <p className="text-gray-600 mb-4 leading-relaxed">
