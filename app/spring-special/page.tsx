...
export default function SpringSpecialPage() {
  return (
    <>
      ...
      ════════════════════════════════════════ */}
      <div className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm px-4" style={{ minHeight: "56px", display: "flex", alignItems: "center" }}>
        <div className="max-w-5xl mx-auto w-full flex items-center justify-between gap-3">
          ...
          <a
            href={PHONE_HREF}
            className="text-gray-800 font-bold text-sm sm:text-base hover:text-orange-500 transition-colors flex items-center gap-1.5 py-3"
