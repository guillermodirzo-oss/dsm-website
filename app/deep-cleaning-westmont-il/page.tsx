...
const faqs = [
  ...
  {
    question: "How much does deep cleaning cost in Westmont, IL?",
    answer:
      "Deep cleaning in Westmont starts around $225 and increases based on home size and current condition. Contact us for a free, no-obligation quote tailored to your specific home.",
  },
  {
    ...
    <>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 mb-4 leading-relaxed">
            Deep cleaning in Westmont starts around $225 for smaller homes and goes up based on the
            size of your home, the number of bedrooms and bathrooms, and how long it&apos;s been since
            your last professional clean. A 3-4 bedroom home near the Westmont downtown area or
            Cass Avenue corridor typically falls in the $275-$375 range.
          </p>
          <p className="text-gray-600 mb-8 leading-relaxed">
            We always give you a free estimate before anything starts. No surprises. You&apos;ll know
            the price before we show up at your Westmont home.
          </p>
          <a href="#quote-form" className="inline-flex items-center gap-2 font-bold text-white rounded-full px-8 py-4 text-base transition-all hover:opacity-90 active:scale-95 shadow-md" style={{ backgroundColor: "#E8721C" }}>
            Get My Free Westmont Quote
          </a>
        </div>
      </section>
