        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div>
              ...
              <p className="text-gray-400 text-sm">Zip code served: 60439</p>
            </div>
            <div>
              <h3 className="font-bold text-xl text-gray-900 mb-4">Local Lemont Landmarks</h3>
              <p className="text-gray-500 mb-4 text-sm leading-relaxed">
                We&apos;re proud to serve the families who live near these well-known local landmarks:
              </p>
              <div className="space-y-2">
                {["Illinois and Michigan Canal", "Lemont Quarries", "Downtown Lemont", "Forge Adventure Park"].map((l) => (
