...
export const metadata: Metadata = {
  title: "Move-Out Cleaning New Lenox IL",
  description:
    "Move-out cleaning in New Lenox, IL. DSM Cleaning Solutions helps you get your deposit back. Fully insured, 48-hr guarantee. Free estimate.",
  alternates: { canonical: "https://www.dsmcleaningsolutions.com/move-out-cleaning-new-lenox-il" },
  openGraph: {
    title: "Move-Out Cleaning New Lenox IL | DSM Cleaning Solutions",
    description:
      "Move-out cleaning in New Lenox, IL. DSM Cleaning Solutions helps you get your deposit back. Fully insured, 48-hr guarantee. Free estimate.",
...
const serviceSchema = {
  ...
  name: "Move-Out Cleaning in New Lenox, IL",
  provider: {
    "@type": "LocalBusiness",
    ...
    <>
      ...
      <section className="py-14 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="section-heading mb-6">Professional Move-Out Cleaning in New Lenox, IL</h2>
          <p className="text-gray-600 mb-4 leading-relaxed">
            Move-out cleaning in New Lenox, IL is about one thing: getting your security deposit back.
          ...
          <p className="text-gray-600 mb-4 leading-relaxed">
            We&rsquo;re a family-owned cleaning company based in Romeoville, just minutes from New Lenox.
            We&rsquo;ve helped renters across Sanctuary, Spencer Pointe, Grand Crossing, Savanna Hills,
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="section-heading">What&rsquo;s Included in Our Move-Out Cleaning in New Lenox, IL</h2>
            <p className="section-subheading mx-auto">
              A complete, landlord-ready clean for your New Lenox property.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">How Much Does Move-Out Cleaning Cost in New Lenox, IL?</h2>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="section-heading">Why New Lenox Renters Choose DSM Cleaning Solutions</h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="text-white">
              ...
              <p className="text-white/90 text-lg mb-6 leading-relaxed">
                ...
                New Lenox, IL. We&rsquo;ll get back to you fast. Same-week appointments are usually available. Every job is backed by our
