...
export const metadata: Metadata = {
  title: "Move-Out Cleaning Joliet IL",
  description:
    "Move-out cleaning in Joliet, IL. DSM Cleaning Solutions helps you get your deposit back. Fully insured, 48-hr guarantee. Free estimate.",
  alternates: { canonical: "https://www.dsmcleaningsolutions.com/move-out-cleaning-joliet-il" },
  openGraph: {
    title: "Move-Out Cleaning Joliet IL | DSM Cleaning Solutions",
    description:
      "Move-out cleaning in Joliet, IL. DSM Cleaning Solutions helps you get your deposit back. Fully insured, 48-hr guarantee. Free estimate.",
...
const reviews3 = pickReviews(3, 4);
    ...
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="hidden lg:block">
              <Image
                ...
                alt="Move-out cleaning in Joliet IL — DSM Cleaning Solutions"
                width={1920}
                height={2560}
      ...
      <section className="py-14 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 mb-4 leading-relaxed">
            Move-out cleaning in Joliet, IL is one of DSM Cleaning Solutions&rsquo; most requested services.
          ...
          <p className="text-gray-600 mb-4 leading-relaxed">
            Our Joliet move-out cleaning isn&rsquo;t a surface-level wipe-down. We clean inside every
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="section-heading">What&rsquo;s Included in Our Move-Out Cleaning in Joliet, IL</h2>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">How Much Does Move-Out Cleaning Cost in Joliet, IL?</h2>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: "Deposit-Back Focused", desc: "Our checklist is built specifically for landlord inspections in Joliet: every appliance, every cabinet, every corner.", icon: "💵" },
              ...
              { title: "Family-Owned & Local", desc: "Based just 10 miles away in Romeoville, your trusted southwest suburbs neighbors. Memo answers his own phone.", icon: "🏠" },
            ].map((card) => (
