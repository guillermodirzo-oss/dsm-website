...
export const metadata: Metadata = {
  ...
  description:
    "Recurring house cleaning in Homer Glen IL by DSM Cleaning Solutions. Trusted, insured & eco-friendly. Call (815) 246-2113.",
...
const faqs = [
  {
    ...
    answer:
      "Most Homer Glen families choose biweekly service Ã¢â‚¬â€ it keeps larger homes consistently clean without overextending your budget. Households with children, pets, or frequent entertaining often prefer weekly cleaning. Monthly service works well for clients who do light maintenance between professional visits.",
  },
  {
    question: "Do you bring your own eco-friendly supplies to Homer Glen?",
    answer:
      "Yes Ã¢â‚¬â€ we arrive fully equipped with all our eco-friendly, non-toxic cleaning products and equipment. You don't need to supply a thing. Our green products are effective on all surfaces common in Homer Glen's well-appointed homes and are safe for your children and pets.",
  },
  {
    question: "Are your Homer Glen cleaners background checked?",
    answer:
      "Yes Ã¢â‚¬â€ every member of our cleaning team is background-checked, insured, and bonded. We take the security of your Homer Glen home seriously, whether you're present during the clean or not.",
  },
  {
    question: "What recurring cleaning plans do you offer in Homer Glen?",
    answer:
      "We offer weekly, biweekly, and monthly recurring cleaning plans for Homer Glen homes. All plans include the same thorough checklist Ã¢â‚¬â€ the frequency is simply adjusted to your household's needs and budget. Contact us at (815) 246-2113 to set up your Homer Glen plan.",
  },
  {
...
const trustCards = [
  { icon: "Ã°Å¸Å’Â¿", title: "Eco-Friendly", desc: "Non-toxic, biodegradable products safe for your Homer Glen family." },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/90 mb-8 leading-relaxed">
              DSM Cleaning Solutions provides reliable, recurring house cleaning for Homer Glen homes Ã¢â‚¬â€
              from Homer Lakes and Farmington Lakes to The Highlands, Tamarack Fairways, and Homer Glen
              Estates. Weekly, biweekly, or monthly Ã¢â‚¬â€ on your schedule, with the consistency your
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 mb-4 leading-relaxed">
            ...
            between deeper cleans Ã¢â‚¬â€ and DSM Cleaning Solutions makes it easy. Whether you live in Homer
          ...
          <p className="text-gray-600 mb-4 leading-relaxed">
            Homer Glen is known for its spacious, upscale residential properties Ã¢â‚¬â€ and larger homes
            require more time and attention to clean properly. We&apos;re a family-owned company based in
            Romeoville, just 15Ã¢â‚¬â€œ20 minutes from Homer Glen, and we understand the higher standard that
            comes with cleaning homes in this community. Our standard cleaning service covers all the
            essentials in every room Ã¢â‚¬â€ kitchens, bathrooms, bedrooms, and living areas Ã¢â‚¬â€ on a schedule
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            are safe for your children and pets Ã¢â‚¬â€ and our background-checked team treats every Homer
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="section-subheading mx-auto">
              A thorough, consistent clean for your Homer Glen home Ã¢â‚¬â€ every visit.
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 mb-4 leading-relaxed">
            ...
            Glen&apos;s larger single-family homes Ã¢â‚¬â€ many of which feature 4+ bedrooms and multiple living
            areas Ã¢â‚¬â€ typically fall in the $175Ã¢â‚¬â€œ$260 per visit range. Recurring clients receive preferred
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="text-white">
              ...
              <p className="text-white/90 text-lg mb-6 leading-relaxed">
                Ready for a consistently clean Homer Glen home? Get your free standard cleaning quote Ã¢â‚¬â€
