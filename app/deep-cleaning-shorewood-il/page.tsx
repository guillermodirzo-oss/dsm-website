...
const faqs = [
  {
    ...
    answer:
      "Yes — DSM Cleaning Solutions provides professional deep cleaning throughout Shorewood, IL (zip code 60404), including Shorewood Glen, Shorewood Crossings, River Crossing, Fox Bend, and Shorewood Commons. We're based in nearby Romeoville and serve the entire Shorewood area.",
  },
  {
    question: "How far is DSM Cleaning Solutions from Shorewood?",
    answer:
      "Our base is in Romeoville, IL — approximately 10–15 minutes from most Shorewood neighborhoods. We serve Shorewood regularly alongside our Joliet and Plainfield clients throughout Will County.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes — DSM Cleaning Solutions is fully insured and bonded in Illinois, including all Shorewood service areas. Every team member is background-checked and we carry liability insurance on every job so you can book with complete peace of mind.",
  },
  {
    question: "How often should Shorewood homes get a professional deep clean?",
    answer:
      "We recommend a professional deep clean at least once or twice a year for most Shorewood homes. Households with pets, allergies, or young children benefit from deep cleaning every 3–4 months. Many clients pair a seasonal deep clean with our ongoing standard cleaning service for year-round results.",
  },
];
...
const trustCards = [
  ...
  { icon: "🛡️", title: "Fully Insured & Bonded", desc: "Background-checked team. Your Shorewood home is fully protected." },
  ...
  { icon: "📅", title: "7 Days a Week", desc: "Flexible scheduling to fit your Shorewood lifestyle." },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/90 mb-8 leading-relaxed">
              ...
              Shorewood — from Shorewood Glen to River Crossing and Fox Bend. Every surface scrubbed,
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 mb-4 leading-relaxed">
            <strong>Deep cleaning in Shorewood, IL</strong> is our specialty — and DSM Cleaning Solutions brings the
          ...
          <p className="text-gray-600 mb-4 leading-relaxed">
            ...
            business based in nearby Romeoville — just minutes away — and we take pride in the results
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="section-subheading mx-auto">
              Every room in your Shorewood home — cleaned top to bottom.
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 mb-4 leading-relaxed">
            ...
            your last professional clean. A 3–4 bedroom home in Shorewood Glen or Shorewood Crossings
          ...
          <p className="text-gray-600 mb-8 leading-relaxed">
            ...
            surprises — you&apos;ll know exactly what to expect before we arrive at your Shorewood home.
          </p>
