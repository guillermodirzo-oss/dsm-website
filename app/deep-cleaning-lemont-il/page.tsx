        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl p-8 md:p-10 relative" style={{ backgroundColor: "#FFF4EE" }}>
            ...
            <blockquote className="pt-8">
              ...
              <footer>
                <p className="font-bold text-gray-900">{REAL_REVIEWS[8].name} <span className="text-amber-400">★★★★★</span></p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="text-white">
              ...
              <p className="font-semibold mb-6" style={{ color: "#FFD8BC" }}>★★★★★ Trusted by {REVIEW_COUNT} Lemont-area homeowners</p>
