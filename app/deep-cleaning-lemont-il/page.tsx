...
export const metadata: Metadata = {
  title: "Deep Cleaning Services Lemont IL",
  description:
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "We serve all of Lemont (60439), including Historic Downtown Lemont, Centennial Crossing, Covington Knolls, Burning Tree Estates, and Heritage Lake, as well as homes near Lemont Quarries, the Illinois & Michigan Canal corridor, and Forge Adventure Park.",
  },
  {
  ...
  return (
    <>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="section-heading">Why Lemont Residents Choose DSM Cleaning Solutions</h2>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="section-heading mb-6">How Much Does Deep Cleaning Cost in Lemont, IL?</h2>
          <p className="text-gray-600 mb-4 leading-relaxed">
