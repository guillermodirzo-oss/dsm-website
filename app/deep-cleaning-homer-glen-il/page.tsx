    ...
    <>
      ...
      <section className="py-10 px-4" style={{ backgroundColor: "#FFF4EE" }}>
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="font-semibold text-gray-700">{REAL_REVIEWS[7].name}</p>
      ...
      >
        ...
        <div className="max-w-xl mx-auto bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-500">Trusted by Homer Glen homeowners — {REVIEW_COUNT} five-star reviews</p>
          </div>
          <CityDeepCleanForm />
        </div>
      </section>
