...
export const metadata: Metadata = {
  ...
  description:
    "Recurring house cleaning in Lockport, IL. DSM Cleaning Solutions - trusted, insured & eco-friendly. Free estimate.",
    ...
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 mb-4 leading-relaxed">
            Standard cleaning in Lockport starts at {formatPrice(STANDARD_CLEANING_TIERS[0].price)} for an average-sized home, with
