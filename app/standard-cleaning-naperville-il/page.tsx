...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "You don&apos;t need to be home. Many Naperville clients share a door code or spare key. Our fully insured, bonded, and background-checked team handles everything while you enjoy your day.",
  },
  {
...
const serviceSchema = {
  ...
  name: "Standard Cleaning in Naperville, IL",
  provider: {
    "@type": "LocalBusiness",
...
const trustCards = [
  ...
  { icon: "", title: "Fully Insured & Bonded", desc: "Background-checked team. Your Naperville home is fully protected." },
