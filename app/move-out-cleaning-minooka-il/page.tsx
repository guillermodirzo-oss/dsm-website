...
const serviceSchema = {
  ...
  description:
    "Move-out cleaning in Minooka, IL. DSM Cleaning Solutions helps you get your deposit back. Eco-friendly, fully insured. Free estimate.",
};
    ...
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl font-bold leading-tight mb-4">
                Move-Out Cleaning in Minooka, IL
              </h1>
            ...
            <div className="hidden lg:block">
              <Image
                ...
                alt="Move-out cleaning in Minooka IL — DSM Cleaning Solutions"
                width={1920}
                height={2560}
      ...
      <section className="py-14 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 mb-4 leading-relaxed">
            We&rsquo;re a family-owned cleaning company from the southwest Chicago suburbs, and we&rsquo;ve
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            <Link href="/move-out-cleaning-plainfield-il" className="text-brand-green font-semibold hover:underline">Plainfield</Link>.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="section-heading">What&rsquo;s Included in Our Move-Out Cleaning in Minooka, IL</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="text-white">
              ...
              <p className="text-white/90 text-lg mb-6 leading-relaxed">
                ...
                Minooka, IL. We&rsquo;ll get back to you fast. Same-week appointments are usually available. Every job is backed by our
