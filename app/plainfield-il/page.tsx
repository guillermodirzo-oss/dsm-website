...
export const metadata: Metadata = {
  ...
  description:
    "DSM Cleaning Solutions serves all of Plainfield, IL Ã¢â‚¬â€ deep cleaning, standard cleaning, move-out & maid service. Family-owned, eco-friendly. Free estimate.",
  keywords: [
...
const localBusinessSchema = {
  ...
  "@type": "LocalBusiness",
  name: "DSM Cleaning Solutions Ã¢â‚¬â€ Plainfield, IL",
  description:
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "We are based in Romeoville, IL Ã¢â‚¬â€ right next to Plainfield. As a local, family-owned business, we're deeply familiar with the Plainfield community and surrounding southwest suburbs.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "We offer standard house cleaning, deep cleaning, move-out and move-in cleaning, weekly/biweekly/monthly recurring maid service, apartment cleaning, eco-friendly green cleaning, post-construction cleaning, and Airbnb turnover cleaning Ã¢â‚¬â€ all available in Plainfield, IL.",
      },
    },
  ],
};
...
const faqs = [
  {
    ...
    answer:
      "We serve all Plainfield neighborhoods including Settlers Ridge, Lakewood Falls, Grande Park, Springbank, Heritage Meadows, and River Run Ã¢â‚¬â€ across both zip codes 60544 and 60585.",
  },
  {
    question: "Are your cleaners background checked in Plainfield?",
    answer:
      "Yes Ã¢â‚¬â€ every member of our cleaning team undergoes a thorough background check before ever entering a client's home. We are also fully insured and bonded on every job.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "We're based in Romeoville, IL Ã¢â‚¬â€ right next door to Plainfield. As a local, family-owned business, we're deeply familiar with the Plainfield community and the surrounding southwest suburbs.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Pricing depends on the size of your home and the type of cleaning. Contact us for a free estimate Ã¢â‚¬â€ we'll provide a personalized quote with no obligation.",
  },
  {
    question: "Do you serve all of Plainfield, including the newer subdivisions?",
    answer:
      "Yes Ã¢â‚¬â€ we serve all of Plainfield, IL including newer developments and subdivisions throughout the 60544 and 60585 zip code areas.",
  },
];
...
const services = [
  ...
  },
  {
    ...
    desc: "Green cleaning using non-toxic, biodegradable products Ã¢â‚¬â€ safe for your family and the environment.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/90 mb-8 leading-relaxed">
              Trusted by Plainfield families Ã¢â‚¬â€ DSM Cleaning Solutions brings family-owned, eco-friendly
      ...
      <section className="bg-white border-b border-gray-100 py-6 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-center gap-6 md:gap-10 text-sm font-medium text-gray-600">
            {["Ã°Å¸â€œÂ Serving All of Plainfield, IL", "Ã°Å¸â€˜Â¨Ã¢â‚¬ÂÃ°Å¸â€˜Â©Ã¢â‚¬ÂÃ°Å¸â€˜Â§ Family Owned", "Ã°Å¸Å’Â¿ Eco-Friendly", "Ã°Å¸â€ºÂ¡Ã¯Â¸Â Fully Insured & Bonded", "Ã¢Å“â€¦ Satisfaction Guaranteed"].map(
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                We use only eco-friendly, non-toxic cleaning products Ã¢â‚¬â€ because Plainfield families deserve a clean home that&apos;s also safe for their kids and pets. Whether you&apos;re in a classic home near Route 30 or a newer build in 60585, we show up prepared with everything we need.
              </p>
            ...
            <div className="bg-brand-green-50 rounded-2xl p-8 border border-brand-green-100">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-6">
                {[
                  { icon: "Ã°Å¸â€˜Â¨Ã¢â‚¬ÂÃ°Å¸â€˜Â©Ã¢â‚¬ÂÃ°Å¸â€˜Â§", label: "Family Owned & Operated" },
                  { icon: "Ã°Å¸â€ºÂ¡Ã¯Â¸Â", label: "Fully Insured & Bonded" },
                  { icon: "Ã°Å¸Å’Â¿", label: "Eco-Friendly Products" },
                  { icon: "Ã¢Å“â€¦", label: "48-Hour Satisfaction Guarantee" },
                  { icon: "Ã°Å¸â€œâ€¦", label: "Available 7 Days a Week" },
                  { icon: "Ã°Å¸â€Â", label: "Background-Checked Team" },
                ].map(item => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div>
              ...
              <p className="text-gray-500 mb-5 leading-relaxed">
                Based in the southwest Chicago suburbs, DSM Cleaning Solutions knows every corner of Plainfield. We clean homes throughout every neighborhood Ã¢â‚¬â€ from the newest developments to established subdivisions we&apos;ve served for years.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="section-subheading mx-auto">
              From one-time deep cleans to weekly maid service Ã¢â‚¬â€ we have a solution for every Plainfield home.
            </p>
          </div>
      ...
      <section className="py-14 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="section-subheading mx-auto">Our two most popular services Ã¢â‚¬â€ see exactly what we cover in your Plainfield home.</p>
          </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-7 border border-gray-200">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <Link href="/standard-cleaning" className="text-brand-green text-sm font-semibold hover:underline">View full details Ã¢â€ â€™</Link>
                </div>
              </div>
            ...
            <div className="bg-orange-50 rounded-2xl p-7 border border-orange-200">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <Link href="/deep-cleaning" className="text-brand-green text-sm font-semibold hover:underline">View full details Ã¢â€ â€™</Link>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <div className="flex items-center justify-center gap-2 mt-2">
              <span className="text-yellow-400 text-xl">Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Link href="/deep-cleaning-plainfield-il" className="bg-white rounded-xl p-5 border border-gray-200 hover:border-brand-green hover:shadow-md transition-all">
              ...
              <p className="text-sm text-gray-600">Top-to-bottom deep cleaning for Plainfield homes Ã¢â‚¬â€ 60544 & 60585.</p>
            </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="text-white">
              ...
              <p className="text-white/80">Local Ã‚Â· Family-owned Ã‚Â· Eco-friendly Ã‚Â· Fully insured Ã‚Â· Satisfaction guaranteed</p>
            </div>
