...
const faqs = [
  {
    ...
    answer:
      "Most deep cleaning jobs in Romeoville take 3-6 hours depending on the size and condition of your home. A 2-bedroom home may take around 3 hours while a larger 4-bedroom home in Augusta Village or Remington Pointe could take 5-6 hours.",
  },
  {
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-green-dark via-brand-green to-brand-green-light text-white pt-12 pb-10 md:pt-16 md:pb-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center gap-2 text-sm text-white/60 mb-6 flex-wrap">
            ...
            <span>/</span>
            <span className="text-white/90">Romeoville</span>
          </nav>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              <h1 className="text-4xl sm:text-5xl font-bold leading-tight mb-3">
                Deep Cleaning Services in Romeoville, IL
              </h1>
              ...
              <p className="text-white/85 text-lg leading-relaxed mb-8">
                DSM Cleaning Solutions scrubs every room in your Romeoville home. Ceiling fans, grout lines, baseboards, the oven. Local, family-owned, and every job comes with a 48-hour satisfaction guarantee.
              </p>
      ...
      <section className="py-14 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Professional Deep Cleaning Services in Romeoville, IL</h2>
          <p className="text-gray-600 mb-4 leading-relaxed">
            Deep cleaning in Romeoville, IL is what we do. DSM Cleaning Solutions brings the same
            detail-focused approach to every home we serve. Whether you live in Augusta Village,
            Lakewood Falls, or Remington Pointe, our team covers zip code 60446 with a thorough clean
            that goes well beyond your regular maintenance routine.
          </p>
          <p className="text-gray-600 mb-4 leading-relaxed">
            Romeoville families choose DSM because we treat every home like our own. We&apos;re not a
            national franchise. We&apos;re a family-owned business based right here in Romeoville. From
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            months of normal use? Our Romeoville deep cleaning service gets it done. We use eco-friendly,
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900">Why Romeoville Residents Choose DSM Cleaning Solutions</h2>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-3">What&apos;s Included in Our Deep Cleaning in Romeoville, IL</h2>
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">Every room in your Romeoville home. Nothing skipped.</p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">How Much Does Deep Cleaning Cost in Romeoville, IL?</h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-10">What Romeoville Homeowners Are Saying</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="text-white">
              <h2 className="text-4xl font-bold mb-3">Book Your Deep Cleaning in Romeoville Today</h2>
              <p className="font-semibold mb-6" style={{ color: "#FFD8BC" }}>★★★★★ Trusted by {REVIEW_COUNT} Romeoville-area homeowners</p>
              <p className="text-white/90 text-lg mb-6 leading-relaxed">
                Get your free deep cleaning quote for Romeoville, IL. We usually respond the same day
