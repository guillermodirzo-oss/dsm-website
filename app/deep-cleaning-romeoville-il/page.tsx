...
export const metadata: Metadata = {
  title: "Deep Cleaning Services Romeoville IL",
  description:
    "Expert deep cleaning in Romeoville, IL (60446). DSM Cleaning Solutions — locally owned, eco-friendly, satisfaction guaranteed. Call (815) 246-2113.",
...
const trustCards = [
  ...
  { icon: "🛡️", title: "Fully Insured & Bonded", desc: "Background-checked team. Every Romeoville job fully covered." },
