...
const faqs = [
  {
    question: "How long does a deep cleaning take in Joliet, IL?",
    answer:
      "Most deep cleaning jobs in Joliet take 3-6 hours depending on the size and condition of your home. A 2-bedroom home may take around 3 hours while a larger 4-bedroom home in the Cathedral Area or Rock Run could take 5-6 hours.",
  },
  {
    question: "Do you serve the Cathedral Area and Rock Run neighborhoods in Joliet?",
    answer:
      "Yes — we serve all Joliet neighborhoods including the Shorewood border area, Cathedral Area, Rock Run, and all areas within zip codes 60431, 60432, and 60435.",
  },
  {
    question: "How much does deep cleaning cost in Joliet, IL?",
    answer:
      "Deep cleaning in Joliet starts around $200 and increases based on home size and current condition. Contact us for a free, no-obligation quote tailored to your specific home.",
  },
  {
    question: "Do I need to be home during the deep cleaning in Joliet?",
    answer:
      "You don't have to be home. Many Joliet clients provide a key or access code. Every member of our team is background-checked, insured, and bonded — your home is fully protected.",
  },
  {
    question: "Is DSM Cleaning Solutions insured in Joliet, IL?",
    answer:
...
const serviceSchema = {
  ...
  name: "Deep Cleaning in Joliet, IL",
  provider: {
    "@type": "LocalBusiness",
  ...
  description:
    "Professional deep cleaning in Joliet, IL — 60431, 60432 & 60435. DSM Cleaning Solutions scrubs every surface, grout line & appliance. Free estimate. (815) 246-2113.",
};
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-green-dark via-brand-green to-brand-green-light text-white pt-12 pb-10 md:pt-16 md:pb-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center gap-2 text-sm text-white/60 mb-6 flex-wrap">
            ...
            <span>/</span>
            <span className="text-white/90">Joliet</span>
          </nav>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              <h1 className="text-4xl sm:text-5xl font-bold leading-tight mb-3">
                Deep Cleaning Services in Joliet, IL
              </h1>
              ...
              <p className="text-white/85 text-lg leading-relaxed mb-8">
                DSM Cleaning Solutions scrubs every room in your Joliet home. Ceiling fans, grout lines, baseboards, the oven. Local, family-owned, and every job comes with a 48-hour satisfaction guarantee.
              </p>
            ...
            <div className="mt-6 lg:mt-0">
              ...
              <img
                ...
                alt="Professionally cleaned bathroom by DSM Cleaning Solutions in Joliet IL"
      ...
      <section className="py-14 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Professional Deep Cleaning Services in Joliet, IL</h2>
          <p className="text-gray-600 mb-4 leading-relaxed">
            Deep cleaning in Joliet, IL is what we do. DSM Cleaning Solutions brings the same
            detail-focused approach to every home we serve. Whether you live near the Cathedral Area,
            Rock Run, or the Shorewood border, our team covers zip codes 60431, 60432, and 60435 with
            a thorough clean that goes well beyond your regular maintenance routine.
          </p>
          <p className="text-gray-600 mb-4 leading-relaxed">
            Joliet families choose DSM because we treat every home like our own. We&apos;re not a
            national franchise. We&apos;re a family-owned business based in the southwest suburbs. From
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            months of normal use? Our Joliet deep cleaning service gets it done. We use eco-friendly,
          ...
          <div className="rounded-2xl p-8 md:p-10 relative" style={{ backgroundColor: "#FFF4EE" }}>
            ...
            <blockquote className="pt-8">
              <p className="text-gray-800 text-lg leading-relaxed mb-5 italic">
                I have three kids and a dog and my house needed serious help. DSM came in and I could not believe how clean everything was. Worth every penny.
              </p>
              <footer>
                <p className="font-bold text-gray-900">Maria V., Joliet IL <span className="text-amber-400">★★★★★</span></p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900">Why Joliet Residents Choose DSM Cleaning Solutions</h2>
          </div>
          ...
          <img
            ...
            alt="Professionally cleaned kitchen in Joliet, IL by DSM Cleaning Solutions"
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-3">What&apos;s Included in Our Deep Cleaning in Joliet, IL</h2>
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">Every room in your Joliet home. Nothing skipped.</p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-10">What Joliet Homeowners Are Saying</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 relative">
              ...
              <p className="text-gray-700 leading-relaxed text-sm pt-6 mb-4">Very professional and thorough. They cleaned things I did not even think to ask about. Baseboards, door frames, behind the toilet. All of it.</p>
              <p className="font-semibold text-gray-900 text-sm">Robert S., Joliet IL</p>
              <p className="text-amber-400 text-sm">★★★★★</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 relative">
              <span className="text-4xl font-serif leading-none absolute top-4 left-5 text-orange-300">&ldquo;</span>
              <p className="text-gray-700 leading-relaxed text-sm pt-6 mb-4">Great experience from start to finish. Easy to book, showed up on time, and did a fantastic job. Will book again.</p>
              <p className="font-semibold text-gray-900 text-sm">Tanya B., Joliet IL</p>
              <p className="text-amber-400 text-sm">★★★★★</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 relative">
              <span className="text-4xl font-serif leading-none absolute top-4 left-5 text-orange-300">&ldquo;</span>
              <p className="text-gray-700 leading-relaxed text-sm pt-6 mb-4">Best cleaning company in the Joliet area. Do not hesitate to book them.</p>
              <p className="font-semibold text-gray-900 text-sm">Carlos P., Joliet IL</p>
              <p className="text-amber-400 text-sm">★★★★★</p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="text-white">
              <h2 className="text-4xl font-bold mb-3">Book Your Deep Cleaning in Joliet Today</h2>
              <p className="font-semibold mb-6" style={{ color: "#FFD8BC" }}>★★★★★ Trusted by 42 Joliet-area homeowners</p>
              <p className="text-white/90 text-lg mb-6 leading-relaxed">
                Get your free deep cleaning quote for Joliet, IL. We usually respond the same day
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <Link href="/deep-cleaning-lockport-il" className="bg-white rounded-xl p-5 border border-gray-200 hover:border-brand-green hover:shadow-md transition-all">
              ...
              <p className="text-sm text-gray-600">Serving 60441 &amp; 60491.</p>
            </Link>
