...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "We serve all of Joliet, including Ingalls Park, Rock Run, Cathedral Area, Forest Park, Woodgate, and White Oak Subdivision. We cover all Joliet zip codes: 60431, 60432, 60433, 60435, and 60436.",
  },
  {
...
const trustCards = [
  ...
  { icon: "🛡️", title: "Fully Insured & Bonded", desc: "Background-checked team. Your Joliet home is fully protected." },
...
export default function DeepCleaningJolietPage() {
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="section-heading mb-6">How Much Does Deep Cleaning Cost in Joliet, IL?</h2>
          <p className="text-gray-600 mb-4 leading-relaxed">
