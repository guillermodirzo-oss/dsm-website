...
const faqs = [
  {
    question: "How long does a deep cleaning take in Lockport, IL?",
    answer:
      "Most deep cleaning jobs in Lockport take 3-6 hours depending on the size and condition of your home. A 2-bedroom home may take around 3 hours while a larger 4-bedroom home near Silver Leaf or the Farrell Road area could take 5-6 hours.",
  },
  {
  ...
  {
    question: "How much does deep cleaning cost in Lockport, IL?",
    answer:
      "Deep cleaning in Lockport starts around $200 and increases based on home size and current condition. Contact us for a free, no-obligation quote tailored to your specific home.",
  },
  {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Lockport, IL", item: "https://www.dsmcleaningsolutions.com/deep-cleaning-lockport-il" },
  ],
};
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-green-dark via-brand-green to-brand-green-light text-white pt-12 pb-10 md:pt-16 md:pb-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center gap-2 text-sm text-white/60 mb-6 flex-wrap">
            ...
            <span>/</span>
            <span className="text-white/90">Lockport</span>
          </nav>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-white/85 text-lg leading-relaxed mb-8">
                DSM Cleaning Solutions scrubs every room in your Lockport home. Ceiling fans, grout lines, baseboards, the oven. Local, family-owned, and every job comes with a 48-hour satisfaction guarantee.
              </p>
            ...
            <div className="mt-6 lg:mt-0">
              ...
              <img
                ...
                alt="Professionally cleaned bathroom by DSM Cleaning Solutions in Lockport IL"
      ...
      <section className="py-14 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Professional Deep Cleaning Services in Lockport, IL</h2>
          <p className="text-gray-600 mb-4 leading-relaxed">
            Deep cleaning in Lockport, IL is what we do. DSM Cleaning Solutions brings the same
            detail-focused approach to every home we serve. Whether you live near the Farrell Road area,
            downtown Lockport, or Silver Leaf, our team covers zip codes 60441 and 60491 with a thorough
            clean that goes well beyond your regular maintenance routine.
          </p>
          <p className="text-gray-600 mb-4 leading-relaxed">
            Lockport families choose DSM because we treat every home like our own. We&apos;re not a
            national franchise. We&apos;re a family-owned business based right here in the southwest
            suburbs. From degreasing the kitchen hood vent to scrubbing grout lines in your master
            shower, nothing gets overlooked.
          </p>
          <p className="text-gray-600 leading-relaxed">
            Getting ready for spring, cleaning up before guests arrive, or just want a real clean after
            months of normal use? Our Lockport deep cleaning service gets it done. We use eco-friendly,
          ...
          <div className="rounded-2xl p-8 md:p-10 relative" style={{ backgroundColor: "#FFF4EE" }}>
            ...
            <blockquote className="pt-8">
              <p className="text-gray-800 text-lg leading-relaxed mb-5 italic">
                Had DSM come out before the holidays and they did an amazing job. The whole house felt fresh and clean. Guests kept asking who cleaned for us.
              </p>
              <footer>
                <p className="font-bold text-gray-900">Nicole F., Lockport IL <span className="text-amber-400">★★★★★</span></p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900">Why Lockport Residents Choose DSM Cleaning Solutions</h2>
          </div>
          ...
          <img
            ...
            alt="Professionally cleaned kitchen in Lockport, IL by DSM Cleaning Solutions"
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-3">What&apos;s Included in Our Deep Cleaning in Lockport, IL</h2>
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">Every room in your Lockport home. Nothing skipped.</p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">How Much Does Deep Cleaning Cost in Lockport, IL?</h2>
          <p className="text-gray-600 mb-4 leading-relaxed">
            Deep cleaning in Lockport starts around $200 for smaller homes and goes up based on the
            size of your home, the number of bedrooms and bathrooms, and how long it&apos;s been since
            your last professional clean. A 3-4 bedroom home near Silver Leaf or downtown Lockport
          ...
          <p className="text-gray-600 mb-8 leading-relaxed">
            ...
            the price before we show up at your Lockport home.
          </p>
          <a href="#quote-form" className="inline-flex items-center gap-2 font-bold text-white rounded-full px-8 py-4 text-base transition-all hover:opacity-90 active:scale-95 shadow-md" style={{ backgroundColor: "#E8721C" }}>
            Get My Free Lockport Quote
          </a>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-10">What Lockport Homeowners Are Saying</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 relative">
              ...
              <p className="text-gray-700 leading-relaxed text-sm pt-6 mb-4">Really glad I found DSM. Local, professional, and they actually care about doing a good job. My kitchen and bathrooms were perfect.</p>
              <p className="font-semibold text-gray-900 text-sm">Brian A., Lockport IL</p>
              <p className="text-amber-400 text-sm">★★★★★</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 relative">
              <span className="text-4xl font-serif leading-none absolute top-4 left-5 text-orange-300">&ldquo;</span>
              <p className="text-gray-700 leading-relaxed text-sm pt-6 mb-4">On time, friendly, and left my house looking better than it has in years. Highly recommend to anyone in Lockport.</p>
              <p className="font-semibold text-gray-900 text-sm">Diane C., Lockport IL</p>
              <p className="text-amber-400 text-sm">★★★★★</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 relative">
              <span className="text-4xl font-serif leading-none absolute top-4 left-5 text-orange-300">&ldquo;</span>
              <p className="text-gray-700 leading-relaxed text-sm pt-6 mb-4">Solid local business. Easy to work with and great results every time.</p>
              <p className="font-semibold text-gray-900 text-sm">Steve H., Lockport IL</p>
              <p className="text-amber-400 text-sm">★★★★★</p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="text-white">
              ...
              <p className="font-semibold mb-6" style={{ color: "#FFD8BC" }}>★★★★★ Trusted by 42 Lockport-area homeowners</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Link href="/deep-cleaning-joliet-il" className="bg-white rounded-xl p-5 border border-gray-200 hover:border-brand-green hover:shadow-md transition-all">
              ...
              <p className="text-sm text-gray-600">Serving 60431, 60432 &amp; 60435.</p>
            </Link>
            ...
            <Link href="/deep-cleaning-homer-glen-il" className="bg-white rounded-xl p-5 border border-gray-200 hover:border-brand-green hover:shadow-md transition-all">
              ...
              <p className="text-sm text-gray-600">Serving all of Homer Glen, IL (60491).</p>
            </Link>
          </div>
        </div>
      </section>
